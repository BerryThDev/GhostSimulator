...
// These are the ghosts evidence types calculated by setting the enum value bit to 1
// Binary: 00000111
#define POLTERGEIST_EV  7
// Binary: 00001011
#define BANSHEE_EV      11
// Binary: 00001101
#define BULLIES_EV      13
// Binary: 00001110
#define PHANTOM_EV      14
...
void initHunter(HunterType**, HouseType*, char[], int*, EvidenceType);
...
void printHunters(FILE*, HunterListType*);
...
void addEvidence (EvidenceListType*, EvidenceType, int);
...
void getFirstEvidenceNode(EvidenceType, EvidenceNodeType**, EvidenceNodeType**);
unsigned char toBitArray(EvidenceListType*);
GhostClass ghostBasedOnEvidence(EvidenceListType*);
